                        ...
                        <div className="space-y-3 mt-4">
                            ...
                            {productCodeFilter && (
                                <div className="border-2 border-orange-200 bg-orange-50 p-3 rounded">
                                    <label className="block text-base font-semibold mb-1">Quantité voulue</label>
                                    <input 
                                        ref={wantedQtyRef}
                            ...
                            <div>
                                <label className="block text-base mb-1 font-medium">Inventaire alloué</label>
                                <input 
                                    className="w-full border p-3 rounded text-base" 
                            ...
                            onClick: () => {
                                ...
                                if (closePallet && palletQty > 0 && palletPrint) {
                                    ...
                                    setTimeout(() => {
                                        ...
                                        if (typeof addToInventory === 'function') {
                                            addToInventory(stockNo, activeJob.wood || 'N/A', palletGrade, activeJob.client || 'N/A', Math.round(qtyPC), palletLoc, getProcessName(activeJob.process));
                                        }
                                ...
                                if (reclassify && reclassifyQty > 0 && reclassifyPrint) {
                                    ...
                                    setTimeout(() => {
                                        ...
                                        if (typeof addToInventory === 'function') {
                                            addToInventory(stockNo, activeJob.wood || 'N/A', newGrade, activeJob.client || 'N/A', Math.round(qtyPC), reclassifyLoc, getProcessName(activeJob.process));
                                        }
